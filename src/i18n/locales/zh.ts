...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    agent: {
      ...
      builtinVaultSearchLabel: '知识库检索',
      builtinVaultSearchDesc:
        '按语义检索 vault，融合知识库向量检索与关键词匹配',
      safetyControls: '安全控制',
    ...
    providers: {
      ...
      promptCaching: '提示缓存',
      promptCachingDesc:
        'Anthropic 临时提示缓存，默认开启。在连续对话中复用系统提示、工具列表和历史消息，显著降低输入 token 消耗与延迟。写缓存有 25% 溢价，命中读取约为原价 10%。仅当上游服务不支持或错误处理 cache_control 字段时才需要关闭。',
    ...
    knowledgeBases: {
      ...
      pendingCount: '{{n}} 个待更新',
      attentionCount: '{{n}} 个知识库需要关注',
      embeddingModelLine: '嵌入模型 {{model}}',
      embeddingModelShelf: '嵌入模型',
      embeddingModelShelfDesc: '所有知识库共用 · 更换需重建索引',
      embeddingModelApiRow: 'API 模型',
      ...
      rebuildThis: '重建此库',
      rebuildAll: '重建全部索引',
      manageDataTitle: '管理索引数据',
      noIndexedData: '尚未建立索引',
      manageModelColumn: '模型',
      manageEmbeddingsColumn: '嵌入总数',
      manageActionsColumn: '操作',
      manageRefresh: '刷新',
      manageRemoveIndex: '移除索引',
      removeIndexFailed: '移除索引失败',
      localEmbedding: {
        groupLabel: '本地',
        ...
        download: '下载',
        downloadingLine: '下载中 {{percent}}% · {{received}} / {{total}}',
        verifying: '正在校验文件…',
        failedLine: '下载失败：{{error}}',
        readyLine: '已下载',
        current: '当前使用',
        viewSource: '来源',
        sourceRepoLabel: '仓库',
        sourceRevisionLabel: '版本',
        sourceFilesLabel: '文件',
        confirmDelete: '再次点击确认删除',
        endpointLabel: '下载源',
        endpointCustomOption: '自定义',
        endpointCustomPlaceholder: 'https://example.com',
        endpointCustomInvalid: '请输入合法的 http/https 地址',
        engineModelNotDownloaded: '本地嵌入模型尚未下载',
        engineModelNotDownloadedSub:
          '请在知识库设置中下载模型后再使用本地嵌入。',
        engineDownloadAction: '下载模型',
        engineModelDownloadingLine: '本地嵌入模型下载中 {{percent}}%',
        engineModelVerifying: '正在校验本地嵌入模型文件…',
        engineModelFailedLine: '本地嵌入模型下载失败：{{error}}',
        engineComponentDisabled: '本地嵌入引擎已禁用',
        engineComponentDisabledSub: '请启用嵌入引擎后再使用本地嵌入。',
        engineEnableAction: '启用',
        engineEnableFailed: '启用嵌入引擎失败',
        engineComponentFailed: '本地嵌入引擎初始化失败',
        engineComponentPreparing: '本地嵌入引擎准备中…',
        engineNonDesktop: '本地嵌入不可用',
        engineNonDesktopSub: '本地嵌入模型仅支持桌面端运行。',
        languageNames: {
          en: '英语',
          zh: '中文',
          multilingual: '多语言',
  ...
  chat: {
    ...
    toolRunSummary: {
      ...
      edit: '编辑 {count} 个文件',
      editedFile: '编辑了 {name}',
      createdFile: '创建了 {name}',
      deletedFile: '删除了 {name}',
